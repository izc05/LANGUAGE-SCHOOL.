...
test('13+: Admin agrupa sus 22 rutas y mantiene navegación completa en tablet y móvil', async ({ page }) => {
  ...
  await expect(nav.getByRole('link', { name: 'Administradores' })).toBeVisible()
