      ...
      <div className="dashboard-content cms-page admin-settings-page">
        ...
        <form className="admin-settings-grid" onSubmit={handleSubmit}>
          ...
          <section className="panel cms-form admin-settings-legal-panel">
            ...
            <div className="settings-legal-note"><strong>Plantillas estructuradas incluidas</strong><p>La web ya presenta responsable, finalidades, bases jurídicas, conservación, destinatarios, derechos, cookies y condiciones de uso. Añade aquí los tratamientos y proveedores reales; no publiques hasta haber revisado menores, videoclases, correo, copias y facturación.</p></div>
            ...
            <label className="field-stack"><span>Condiciones de matrícula y contratación</span><textarea rows={10} value={form.enrollmentTermsText} onChange={(event) => setField('enrollmentTermsText', event.target.value)} placeholder="Matrícula, duración, precio total e impuestos, forma de pago, bajas, recuperaciones, clases online, materiales, menores, desistimiento cuando aplique y reclamaciones..." /><small>Esta página se muestra desde el footer. Debe contener las condiciones reales aprobadas por la academia antes de permitir una contratación o pago online.</small></label>
          </section>
