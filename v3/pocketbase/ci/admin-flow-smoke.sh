...
echo '1/14 Authenticate CI superuser'
...
echo '2/14 Create application ADMIN with superuser bootstrap'
...
echo '3/14 Authenticate as application ADMIN (all following writes use ADMIN rules)'
...
echo '4/14 Create teacher + teacher profile through ADMIN rules'
...
echo '5/14 Create student + student profile through ADMIN rules'
...
echo '6/14 Create course + group with assigned teacher'
...
echo '7/14 Enroll student in group'
...
echo '8/14 Create scheduled class'
...
echo '9/14 PATCH student account through user update hooks'
...
echo '10/14 PATCH group through teacher assignment hooks'
...
echo '11/14 PATCH class through class update hooks'
...
echo '12/14 Register attendance and verify persisted relation chain'
...
echo '13/14 Close enrollment as FINISHED'
...
echo '14/14 Closed enrollment cannot transition back to PAUSED'
