...
routerAdd("GET", "/api/language-school/zoom/status", (e) => {
  ...
  const hostUserConfigured = Boolean(hostUserId)
  const meetingCreationConfigured = apiConfigured && hostUserConfigured
  ...
  return e.json(200, {
    ...
    apiConfigured,
    hostUserConfigured,
    meetingCreationConfigured,
    meetingSdkConfigured,
    configured: meetingCreationConfigured && meetingSdkConfigured,
  })
